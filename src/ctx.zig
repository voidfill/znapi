...
pub const getBigintWordLength = wrappers.getBigintWordLength;
pub const getBoolean = wrappers.getBoolean;
pub const getBufferInfo = wrappers.getBufferInfo;
pub const getCallbackArgs = wrappers.getCallbackArgs;
pub const getCallbackData = wrappers.getCallbackData;
...
pub const getStringLengthLatin1 = wrappers.getStringLengthLatin1;
pub const getStringLengthUtf16 = wrappers.getStringLengthUtf16;
pub const getStringLengthUtf8 = wrappers.getStringLengthUtf8;
pub const getUndefined = wrappers.getUndefined;
pub const getUvEventLoop = wrappers.getUvEventLoop;
pub const getValueBigintBytes = wrappers.getValueBigintBytes;
